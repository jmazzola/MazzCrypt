...
private:
	...
	std::string m_szMapName = Decrypt(15,25,55,121,23,58,44,125,26,58,20,4,1,23,1,1);





	bool PANPKRBWXI = true;
char* HZMBRLZZOM = "BEVXUOVSDWN";
bool OBUCKNSMCN = true;
float GVDFCTVFDV = 44.67f;
